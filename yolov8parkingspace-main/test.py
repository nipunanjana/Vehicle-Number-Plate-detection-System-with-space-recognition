...
#define a frame name as "RGB" and set the mouse to that frame
cv2.namedWindow('RGB')
...
# Count cars in each area    
    ...
    print(space)                                    # print occupied spaces in terminal
...
# print slot id and availability in terminal      
...
# pass and update data with database    
